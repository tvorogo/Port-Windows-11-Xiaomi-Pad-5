...
>[!NOTE]
> Настройте автоматическую прошивку boot.img Android **при загрузке Windows** или **при низком уровне заряда батареи**, чтобы предотвратить разрядку планшета с прошитым `uefi.img`.

- Скачайте последнюю версию **boot.img Auto-Flasher** [здесь](https://github.com/Misha803/WOA-Tools/releases/tag/boot.img-Auto-Flasher).
- Запустите её и следуйте инструкциям мастера настройки, чтобы выбрать условия автоматической прошивки Android `boot.img`.
- С помощью ползунка выберите порог заряда батареи от **10% до 30%**.
> Если служба уже установлена, используйте **`REINSTALL/UPDATE`**, чтобы обновить её.
...
- Запустите [USB Mode Control](https://github.com/Misha803/WOA-Tools/releases/tag/USB-Host-Mode-Control) (новее) или [usbhostmodenative tool](https://github.com/n00b69/usbhostmode) для включения или отключения режима USB хоста.
...
- ✅ **Да!** Вы можете обновлять Android любым образом, просто используйте [гайд по ре-рутингу Android](Re-rooting-ru.md) после обновления.
