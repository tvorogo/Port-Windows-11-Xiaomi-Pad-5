...
> [!NOTE]
> Эта инструкция не рекомендуется для обновления установки со старой версии драйверов. Обновление старой установки может привести к неправильной конфигурации или нестабильной работе системы.
