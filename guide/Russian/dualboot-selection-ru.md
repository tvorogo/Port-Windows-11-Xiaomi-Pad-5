...
| - использование приложения для перезагрузки в Windows | - использование магнитного чехла для перезагрузки в Windows
| - Универсален и работает почти всегда    | - Не работает на части планшетов
