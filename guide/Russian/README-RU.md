...
## Языки
**```Русский```** | [```English```](/README.md) | [```Ukrainian```](/guide/Ukrainian/README-uk.md) 
...
> [!WARNING]
> Если вы боитесь модифицировать планшет, изменять его таблицу разделов или получить кирпич, самое время прекратить чтение. Однако установка Windows достаточно проста, и даже новички смогут разобраться в ней: просто внимательно следуйте инструкции, и всё получится!

> [!CAUTION]
>> **❗Если вы используете драйверы и UEFI старее v2501.27, необходимо обновить или переустановить Windows с использованием [последнего релиза](https://github.com/remtrik-stuff/MiPad5-Windows-Releases/releases). ❗**
> ***Обратите внимание, что обновление возможно и может работать, но разработчик этого не рекомендует.***
>
> **В ПРОТИВНОМ СЛУЧАЕ ВАША UFS МОЖЕТ УМЕРЕТЬ В ЛЮБОЙ МОМЕНТ, НЕСМОТРЯ НИ НА ЧТО!**
>
