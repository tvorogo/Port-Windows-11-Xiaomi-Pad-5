...
### 4. Розблокування завантажувача:
 ...
 - Якщо на 99% відображається помилка періоду очікування (ймовірно 168 годин/7 днів), закрийте все та зачекайте доки період не закінчиться, а потім повторіть крок 4.
