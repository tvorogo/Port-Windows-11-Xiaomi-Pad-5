...
> [!NOTE]
> Цей посібник не рекомендується для оновлення встановлення зі старої версії драйверів. Оновлення старого встановлення може призвести до неправильної конфігурації або нестабільної роботи системи.
