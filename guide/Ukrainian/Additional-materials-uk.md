...
> [!Note]
> Налаштуйте автоматичне перепрошивання Android boot.img під час завантаження Windows або коли заряд батареї низький (<15%/20%), щоб запобігти розрядці батареї з прошитим uefi.img.
...
- Запустіть [USB Mode Control](https://github.com/Misha803/My-Scripts/releases/tag/USB-Host-Mode-Control) або [usbhostmodenative](https://github.com/n00b69/usbhostmode) щоб увімкнути/вимкнути режим USB-хоста.
