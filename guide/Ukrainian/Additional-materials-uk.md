...
### Налаштування автоматичного перепрошивання Android boot.img

> [!NOTE]
> Налаштуйте автоматичне перепрошивання Android boot.img під час завантаження Windows або за низького заряду батареї, щоб запобігти розряджанню планшета з прошитим `uefi.img`.

- Завантажте останню версію **boot.img Auto-Flasher** [тут](https://github.com/Misha803/WOA-Tools/releases/tag/boot.img-Auto-Flasher).
- Запустіть її та дотримуйтеся інструкцій майстра налаштування, щоб вибрати умови автоматичного прошивання Android `boot.img`.
- За допомогою повзунка виберіть поріг заряду батареї від **10% до 30%**.
> Якщо службу вже встановлено, використайте **`REINSTALL/UPDATE`**, щоб оновити її.
...
- Запустіть [USB Mode Control](https://github.com/Misha803/WOA-Tools/releases/tag/USB-Host-Mode-Control) або [usbhostmodenative](https://github.com/n00b69/usbhostmode) щоб увімкнути/вимкнути режим USB-хоста.
...
- ✅ **Так!** Ви можете оновити Android будь-яким способом, просто скористайтеся [посібником із повторного отримання root прав](Re-rooting-uk.md) після оновлення
